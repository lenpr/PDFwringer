...
- **Logs**: Diagnostic logs are stored locally at `~/Library/Logs/PDFwringer/` and are never transmitted. You can view or delete them at any time via Help > Show Logs.
